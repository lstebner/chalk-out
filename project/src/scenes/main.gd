...
onready var tasks_list = $VBoxContainer/Main/HBoxContainer/TabContainer/Backlog/TasksList
onready var completed_tasks = $VBoxContainer/Main/HBoxContainer/TabContainer/Completed/CompletedTasks
onready var in_progress_tasks = $"VBoxContainer/Main/HBoxContainer/TabContainer/In Progress/InProgressTasks"
...
func _ready():
    ...
    in_progress_tasks.connect("task_selected", self, "_on_task_selected")
...
func _on_project_selected(project_id):
    ...
    in_progress_tasks.set_project(project)
